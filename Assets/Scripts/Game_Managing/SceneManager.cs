...
namespace Game_Managing
{
    ...
    { //TODO: remove static modifier
        ...
        public static string GetPath(Scene scene)
        {
            ...
            string sceneName;
            switch(scene) {
                case Scene.MainMenu: sceneName = "";
                case Scene.TutorialIsland: sceneName = "";
                case Scene.FlowerIsland: sceneName = "";
                case Scene.FeatherIsland: sceneName = "";
                case Scene.LibraryIsland: sceneName = "";
                case Scene.StainedGlassIsland: sceneName = "";
                case Scene.Graveyard: sceneName = "";
                default: throw new ArgumentException("Invalid Scene ID");
            };
